...
@section('content')
    <a class="back-link" href="{{ route('admin.laws.edit', ['edition' => request()->route('edition'), 'law' => $law]) }}">Back to law editor</a>
    ...
    <details class="card collapse-card">
        ...
        <div class="collapse-body">
            <form action="{{ route('admin.nodes.update', ['edition' => request()->route('edition'), 'law' => $law, 'node' => $node]) }}" method="post" enctype="multipart/form-data" class="stack-form">
                @csrf
                @method('patch')
