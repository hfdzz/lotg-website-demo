<div class="hub-nav-list">
    <a class="hub-nav-link @if (($currentKey ?? null) === 'laws') is-active @endif" href="{{ route('laws.index', array_filter(['lang' => $language, 'edition' => $lawsEditionQueryId ?? null], fn ($value) => $value !== null && $value !== '')) }}">
